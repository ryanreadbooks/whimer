        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/conductor.api.namespace.v1.NamespaceService/CreateNamespace",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "conductor.api.namespace.v1.NamespaceService",
                        "CreateNamespace",
                    ),
                );
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/conductor.api.namespace.v1.NamespaceService/ListNamespace",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
...
pub mod namespace_service_server {
    ...
    pub const SERVICE_NAME: &str = "conductor.api.namespace.v1.NamespaceService";
