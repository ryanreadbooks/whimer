        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/conductor.api.task.v1.TaskService/RegisterTask",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("conductor.api.task.v1.TaskService", "RegisterTask"),
                );
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/conductor.api.task.v1.TaskService/GetTask",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("conductor.api.task.v1.TaskService", "GetTask"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn abort_task(
            ...
            tonic::Response<super::AbortTaskResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/conductor.api.task.v1.TaskService/AbortTask",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("conductor.api.task.v1.TaskService", "AbortTask"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
...
pub mod task_service_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/conductor.api.task.v1.TaskService/AbortTask" => {
                    ...
                    impl<
                        T: TaskService,
                    > tonic::server::UnaryService<super::AbortTaskRequest>
                    for AbortTaskSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as TaskService>::abort_task(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "conductor.api.task.v1.TaskService";
