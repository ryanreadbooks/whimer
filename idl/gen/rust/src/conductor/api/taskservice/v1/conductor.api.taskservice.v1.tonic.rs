        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/conductor.api.taskservice.v1.TaskService/RegisterTask",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "conductor.api.taskservice.v1.TaskService",
                        "RegisterTask",
                    ),
                );
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/conductor.api.taskservice.v1.TaskService/GetTask",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/conductor.api.taskservice.v1.TaskService/AbortTask",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
...
pub mod task_service_server {
    ...
    pub const SERVICE_NAME: &str = "conductor.api.taskservice.v1.TaskService";
