        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/conductor.api.namespaceservice.v1.NamespaceService/CreateNamespace",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "conductor.api.namespaceservice.v1.NamespaceService",
                        "CreateNamespace",
                    ),
                );
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/conductor.api.namespaceservice.v1.NamespaceService/ListNamespace",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
...
pub mod namespace_service_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/conductor.api.namespaceservice.v1.NamespaceService/CreateNamespace" => {
                    ...
                    struct CreateNamespaceSvc<T: NamespaceService>(pub Arc<T>);
                    impl<
                        T: NamespaceService,
                    ...
                    for CreateNamespaceSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as NamespaceService>::create_namespace(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/conductor.api.namespaceservice.v1.NamespaceService/ListNamespace" => {
                    #[allow(non_camel_case_types)]
                    struct ListNamespaceSvc<T: NamespaceService>(pub Arc<T>);
                    impl<
                        T: NamespaceService,
                    ...
                    for ListNamespaceSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as NamespaceService>::list_namespace(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
    ...
    pub const SERVICE_NAME: &str = "conductor.api.namespaceservice.v1.NamespaceService";
