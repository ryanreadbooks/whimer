...
const (
	AccessService_IsCheckedIn_FullMethodName = "/passport.api.access.v1.AccessService/IsCheckedIn"
)
...
var AccessService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "passport.api.access.v1.AccessService",
	...
	Metadata: "passport/api/access/v1/access.proto",
}
