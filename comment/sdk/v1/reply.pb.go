...
type CheckUserOnOjbectRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *CheckUserOnOjbectRequest) Reset() {
	*x = CheckUserOnOjbectRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *CheckUserOnOjbectRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CheckUserOnOjbectRequest) ProtoMessage() {}

func (x *CheckUserOnOjbectRequest) ProtoReflect() protoreflect.Message {
	mi := &file_v1_reply_proto_msgTypes[30]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CheckUserOnOjbectRequest.ProtoReflect.Descriptor instead.
func (*CheckUserOnOjbectRequest) Descriptor() ([]byte, []int) {
	return file_v1_reply_proto_rawDescGZIP(), []int{30}
}

func (x *CheckUserOnOjbectRequest) GetOid() uint64 {
	if x != nil {
		return x.Oid
	}
	return 0
...
func (x *CheckUserOnOjbectRequest) GetUid() uint64 {
	if x != nil {
		return x.Uid
	}
	return 0
...
type CheckUserOnOjbectResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Result *CheckUserCommentPair `protobuf:"bytes,1,opt,name=result,proto3" json:"result,omitempty"`
}

func (x *CheckUserOnOjbectResponse) Reset() {
	*x = CheckUserOnOjbectResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *CheckUserOnOjbectResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CheckUserOnOjbectResponse) ProtoMessage() {}

func (x *CheckUserOnOjbectResponse) ProtoReflect() protoreflect.Message {
	mi := &file_v1_reply_proto_msgTypes[31]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CheckUserOnOjbectResponse.ProtoReflect.Descriptor instead.
func (*CheckUserOnOjbectResponse) Descriptor() ([]byte, []int) {
	return file_v1_reply_proto_rawDescGZIP(), []int{31}
}

func (x *CheckUserOnOjbectResponse) GetResult() *CheckUserCommentPair {
	if x != nil {
		return x.Result
	}
	return nil
...
type BatchCheckUserOnOjbectRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Mappings map[uint64]uint64 `protobuf:"bytes,1,rep,name=mappings,proto3" json:"mappings,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"` // uid ——> oid
}

func (x *BatchCheckUserOnOjbectRequest) Reset() {
	*x = BatchCheckUserOnOjbectRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *BatchCheckUserOnOjbectRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BatchCheckUserOnOjbectRequest) ProtoMessage() {}

func (x *BatchCheckUserOnOjbectRequest) ProtoReflect() protoreflect.Message {
	mi := &file_v1_reply_proto_msgTypes[32]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BatchCheckUserOnOjbectRequest.ProtoReflect.Descriptor instead.
func (*BatchCheckUserOnOjbectRequest) Descriptor() ([]byte, []int) {
	return file_v1_reply_proto_rawDescGZIP(), []int{32}
}

func (x *BatchCheckUserOnOjbectRequest) GetMappings() map[uint64]uint64 {
	if x != nil {
		return x.Mappings
	}
	return nil
...
type CheckUserCommentPair struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *CheckUserCommentPair) Reset() {
	*x = CheckUserCommentPair{}
	if protoimpl.UnsafeEnabled {
...
func (x *CheckUserCommentPair) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CheckUserCommentPair) ProtoMessage() {}

func (x *CheckUserCommentPair) ProtoReflect() protoreflect.Message {
	mi := &file_v1_reply_proto_msgTypes[33]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CheckUserCommentPair.ProtoReflect.Descriptor instead.
func (*CheckUserCommentPair) Descriptor() ([]byte, []int) {
	return file_v1_reply_proto_rawDescGZIP(), []int{33}
}

func (x *CheckUserCommentPair) GetOid() uint64 {
	if x != nil {
		return x.Oid
	}
	return 0
...
func (x *CheckUserCommentPair) GetUid() uint64 {
	if x != nil {
		return x.Uid
	}
	return 0
...
func (x *CheckUserCommentPair) GetCommented() bool {
	if x != nil {
		return x.Commented
	}
	return false
...
type BatchCheckUserOnOjbectResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Results []*CheckUserCommentPair `protobuf:"bytes,1,rep,name=results,proto3" json:"results,omitempty"`
}

func (x *BatchCheckUserOnOjbectResponse) Reset() {
	*x = BatchCheckUserOnOjbectResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *BatchCheckUserOnOjbectResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BatchCheckUserOnOjbectResponse) ProtoMessage() {}

func (x *BatchCheckUserOnOjbectResponse) ProtoReflect() protoreflect.Message {
	mi := &file_v1_reply_proto_msgTypes[34]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BatchCheckUserOnOjbectResponse.ProtoReflect.Descriptor instead.
func (*BatchCheckUserOnOjbectResponse) Descriptor() ([]byte, []int) {
	return file_v1_reply_proto_rawDescGZIP(), []int{34}
}

func (x *BatchCheckUserOnOjbectResponse) GetResults() []*CheckUserCommentPair {
	if x != nil {
		return x.Results
	}
	return nil
...
var file_v1_reply_proto_rawDesc = []byte{
	...
	0x6e, 0x4f, 0x6a, 0x62, 0x65, 0x63, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x19,
	...
	,
	...
	0x73, 0x65, 0x72, 0x4f, 0x6e, 0x4f, 0x6a, 0x62, 0x65, 0x63, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x2e, 0x4d, 0x61, 0x70, 0x70, 0x69, 0x6e, 0x67, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79,
	0x52, 0x08, 0x6d, 0x61, 0x70, 0x70, 0x69, 0x6e, 0x67, 0x73, 0x1a, 0x3b, 0x0a, 0x0d, 0x4d, 0x61,
	...
	0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x58, 0x0a, 0x14, 0x43, 0x68, 0x65, 0x63, 0x6b,
	0x55, 0x73, 0x65, 0x72, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x50, 0x61, 0x69, 0x72, 0x12,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
...
var file_v1_reply_proto_msgTypes = make([]protoimpl.MessageInfo, 37)
var file_v1_reply_proto_goTypes = []any{
	...
	(*CheckUserOnOjbectRequest)(nil),       // 32: comment.sdk.v1.CheckUserOnOjbectRequest
	(*CheckUserOnOjbectResponse)(nil),      // 33: comment.sdk.v1.CheckUserOnOjbectResponse
	(*BatchCheckUserOnOjbectRequest)(nil),  // 34: comment.sdk.v1.BatchCheckUserOnOjbectRequest
	(*CheckUserCommentPair)(nil),           // 35: comment.sdk.v1.CheckUserCommentPair
	(*BatchCheckUserOnOjbectResponse)(nil), // 36: comment.sdk.v1.BatchCheckUserOnOjbectResponse
	nil,                                    // 37: comment.sdk.v1.BatchCountReplyResponse.NumbersEntry
	nil,                                    // 38: comment.sdk.v1.BatchCheckUserOnOjbectRequest.MappingsEntry
}
var file_v1_reply_proto_depIdxs = []int32{
	...
	37, // 11: comment.sdk.v1.BatchCountReplyResponse.numbers:type_name -> comment.sdk.v1.BatchCountReplyResponse.NumbersEntry
	35, // 12: comment.sdk.v1.CheckUserOnOjbectResponse.result:type_name -> comment.sdk.v1.CheckUserCommentPair
	38, // 13: comment.sdk.v1.BatchCheckUserOnOjbectRequest.mappings:type_name -> comment.sdk.v1.BatchCheckUserOnOjbectRequest.MappingsEntry
	35, // 14: comment.sdk.v1.BatchCheckUserOnOjbectResponse.results:type_name -> comment.sdk.v1.CheckUserCommentPair
	2,  // 15: comment.sdk.v1.ReplyService.AddReply:input_type -> comment.sdk.v1.AddReplyReq
	4,  // 16: comment.sdk.v1.ReplyService.DelReply:input_type -> comment.sdk.v1.DelReplyReq
	6,  // 17: comment.sdk.v1.ReplyService.LikeAction:input_type -> comment.sdk.v1.LikeActionReq
	8,  // 18: comment.sdk.v1.ReplyService.DislikeAction:input_type -> comment.sdk.v1.DislikeActionReq
	10, // 19: comment.sdk.v1.ReplyService.ReportReply:input_type -> comment.sdk.v1.ReportReplyReq
	12, // 20: comment.sdk.v1.ReplyService.PinReply:input_type -> comment.sdk.v1.PinReplyReq
	14, // 21: comment.sdk.v1.ReplyService.PageGetReply:input_type -> comment.sdk.v1.PageGetReplyReq
	17, // 22: comment.sdk.v1.ReplyService.PageGetSubReply:input_type -> comment.sdk.v1.PageGetSubReplyReq
	14, // 23: comment.sdk.v1.ReplyService.PageGetDetailedReply:input_type -> comment.sdk.v1.PageGetReplyReq
	22, // 24: comment.sdk.v1.ReplyService.GetPinnedReply:input_type -> comment.sdk.v1.GetPinnedReplyReq
	24, // 25: comment.sdk.v1.ReplyService.CountReply:input_type -> comment.sdk.v1.CountReplyReq
	26, // 26: comment.sdk.v1.ReplyService.BatchCountReply:input_type -> comment.sdk.v1.BatchCountReplyRequest
	28, // 27: comment.sdk.v1.ReplyService.GetReplyLikeCount:input_type -> comment.sdk.v1.GetReplyLikeCountReq
	30, // 28: comment.sdk.v1.ReplyService.GetReplyDislikeCount:input_type -> comment.sdk.v1.GetReplyDislikeCountReq
	32, // 29: comment.sdk.v1.ReplyService.CheckUserOnOjbect:input_type -> comment.sdk.v1.CheckUserOnOjbectRequest
	34, // 30: comment.sdk.v1.ReplyService.BatchCheckUserOnOjbect:input_type -> comment.sdk.v1.BatchCheckUserOnOjbectRequest
	3,  // 31: comment.sdk.v1.ReplyService.AddReply:output_type -> comment.sdk.v1.AddReplyRes
	5,  // 32: comment.sdk.v1.ReplyService.DelReply:output_type -> comment.sdk.v1.DelReplyRes
	7,  // 33: comment.sdk.v1.ReplyService.LikeAction:output_type -> comment.sdk.v1.LikeActionRes
	9,  // 34: comment.sdk.v1.ReplyService.DislikeAction:output_type -> comment.sdk.v1.DislikeActionRes
	11, // 35: comment.sdk.v1.ReplyService.ReportReply:output_type -> comment.sdk.v1.ReportReplyRes
	13, // 36: comment.sdk.v1.ReplyService.PinReply:output_type -> comment.sdk.v1.PinReplyRes
	16, // 37: comment.sdk.v1.ReplyService.PageGetReply:output_type -> comment.sdk.v1.PageGetReplyRes
	18, // 38: comment.sdk.v1.ReplyService.PageGetSubReply:output_type -> comment.sdk.v1.PageGetSubReplyRes
	21, // 39: comment.sdk.v1.ReplyService.PageGetDetailedReply:output_type -> comment.sdk.v1.PageGetDetailedReplyRes
	23, // 40: comment.sdk.v1.ReplyService.GetPinnedReply:output_type -> comment.sdk.v1.GetPinnedReplyRes
	25, // 41: comment.sdk.v1.ReplyService.CountReply:output_type -> comment.sdk.v1.CountReplyRes
	27, // 42: comment.sdk.v1.ReplyService.BatchCountReply:output_type -> comment.sdk.v1.BatchCountReplyResponse
	29, // 43: comment.sdk.v1.ReplyService.GetReplyLikeCount:output_type -> comment.sdk.v1.GetReplyLikeCountRes
	31, // 44: comment.sdk.v1.ReplyService.GetReplyDislikeCount:output_type -> comment.sdk.v1.GetReplyDislikeCountRes
	33, // 45: comment.sdk.v1.ReplyService.CheckUserOnOjbect:output_type -> comment.sdk.v1.CheckUserOnOjbectResponse
	36, // 46: comment.sdk.v1.ReplyService.BatchCheckUserOnOjbect:output_type -> comment.sdk.v1.BatchCheckUserOnOjbectResponse
...
func file_v1_reply_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_v1_reply_proto_msgTypes[30].Exporter = func(v any, i int) any {
			switch v := v.(*CheckUserOnOjbectRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_v1_reply_proto_msgTypes[31].Exporter = func(v any, i int) any {
			switch v := v.(*CheckUserOnOjbectResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_v1_reply_proto_msgTypes[32].Exporter = func(v any, i int) any {
			switch v := v.(*BatchCheckUserOnOjbectRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_v1_reply_proto_msgTypes[33].Exporter = func(v any, i int) any {
			switch v := v.(*CheckUserCommentPair); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_v1_reply_proto_msgTypes[34].Exporter = func(v any, i int) any {
			switch v := v.(*BatchCheckUserOnOjbectResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
