...
var file_v1_comment_proto_rawDesc = []byte{
	...
	0x65, 0x6e, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x2a,
	...
	0x07, 0x42, 0x79, 0x54, 0x72, 0x65, 0x6e, 0x64, 0x10, 0x01, 0x32, 0xbe, 0x10, 0x0a, 0x0e, 0x43,
	...
	0x67, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0xac, 0x01, 0x0a, 0x12,
	0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x61, 0x70, 0x69, 0x2e,
	...
	0x6d, 0x65, 0x72, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x2f, 0x61, 0x70, 0x69, 0x2f,
	0x76, 0x31, 0xa2, 0x02, 0x03, 0x43, 0x41, 0x58, 0xaa, 0x02, 0x0e, 0x43, 0x6f, 0x6d, 0x6d, 0x65,
	0x6e, 0x74, 0x2e, 0x41, 0x70, 0x69, 0x2e, 0x56, 0x31, 0xca, 0x02, 0x0e, 0x43, 0x6f, 0x6d, 0x6d,
	0x65, 0x6e, 0x74, 0x5c, 0x41, 0x70, 0x69, 0x5c, 0x56, 0x31, 0xe2, 0x02, 0x1a, 0x43, 0x6f, 0x6d,
	0x6d, 0x65, 0x6e, 0x74, 0x5c, 0x41, 0x70, 0x69, 0x5c, 0x56, 0x31, 0x5c, 0x47, 0x50, 0x42, 0x4d,
	0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0xea, 0x02, 0x10, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e,
	0x74, 0x3a, 0x3a, 0x41, 0x70, 0x69, 0x3a, 0x3a, 0x56, 0x31, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_v1_comment_proto_msgTypes = make([]protoimpl.MessageInfo, 60)
var file_v1_comment_proto_goTypes = []any{
	...
	nil,                                           // 55: comment.api.v1.BatchCountCommentResponse.NumbersEntry
	(*BatchCheckUserOnObjectRequest_Objects)(nil), // 56: comment.api.v1.BatchCheckUserOnObjectRequest.Objects
	nil, // 57: comment.api.v1.BatchCheckUserOnObjectRequest.MappingsEntry
	nil, // 58: comment.api.v1.BatchCheckUserOnObjectResponse.ResultsEntry
	(*BatchCheckUserLikeCommentRequest_CommentIdList)(nil), // 59: comment.api.v1.BatchCheckUserLikeCommentRequest.CommentIdList
	nil, // 60: comment.api.v1.BatchCheckUserLikeCommentRequest.MappingsEntry
	(*BatchCheckUserLikeCommentResponse_CommentLikedList)(nil), // 61: comment.api.v1.BatchCheckUserLikeCommentResponse.CommentLikedList
	nil, // 62: comment.api.v1.BatchCheckUserLikeCommentResponse.ResultsEntry
}
var file_v1_comment_proto_depIdxs = []int32{
	...
	55, // 25: comment.api.v1.BatchCountCommentResponse.numbers:type_name -> comment.api.v1.BatchCountCommentResponse.NumbersEntry
	47, // 26: comment.api.v1.CheckUserOnObjectResponse.result:type_name -> comment.api.v1.OidCommented
	57, // 27: comment.api.v1.BatchCheckUserOnObjectRequest.mappings:type_name -> comment.api.v1.BatchCheckUserOnObjectRequest.MappingsEntry
	47, // 28: comment.api.v1.OidCommentedList.list:type_name -> comment.api.v1.OidCommented
	58, // 29: comment.api.v1.BatchCheckUserOnObjectResponse.results:type_name -> comment.api.v1.BatchCheckUserOnObjectResponse.ResultsEntry
	60, // 30: comment.api.v1.BatchCheckUserLikeCommentRequest.mappings:type_name -> comment.api.v1.BatchCheckUserLikeCommentRequest.MappingsEntry
	62, // 31: comment.api.v1.BatchCheckUserLikeCommentResponse.results:type_name -> comment.api.v1.BatchCheckUserLikeCommentResponse.ResultsEntry
	56, // 32: comment.api.v1.BatchCheckUserOnObjectRequest.MappingsEntry.value:type_name -> comment.api.v1.BatchCheckUserOnObjectRequest.Objects
	48, // 33: comment.api.v1.BatchCheckUserOnObjectResponse.ResultsEntry.value:type_name -> comment.api.v1.OidCommentedList
	59, // 34: comment.api.v1.BatchCheckUserLikeCommentRequest.MappingsEntry.value:type_name -> comment.api.v1.BatchCheckUserLikeCommentRequest.CommentIdList
	51, // 35: comment.api.v1.BatchCheckUserLikeCommentResponse.CommentLikedList.list:type_name -> comment.api.v1.CommentLiked
	61, // 36: comment.api.v1.BatchCheckUserLikeCommentResponse.ResultsEntry.value:type_name -> comment.api.v1.BatchCheckUserLikeCommentResponse.CommentLikedList
	4,  // 37: comment.api.v1.CommentService.AddComment:input_type -> comment.api.v1.AddCommentRequest
	7,  // 38: comment.api.v1.CommentService.DelComment:input_type -> comment.api.v1.DelCommentRequest
	9,  // 39: comment.api.v1.CommentService.LikeAction:input_type -> comment.api.v1.LikeActionRequest
	11, // 40: comment.api.v1.CommentService.DislikeAction:input_type -> comment.api.v1.DislikeActionRequest
	13, // 41: comment.api.v1.CommentService.ReportComment:input_type -> comment.api.v1.ReportCommentRequest
	15, // 42: comment.api.v1.CommentService.PinComment:input_type -> comment.api.v1.PinCommentRequest
	17, // 43: comment.api.v1.CommentService.PageGetComment:input_type -> comment.api.v1.PageGetCommentRequest
	22, // 44: comment.api.v1.CommentService.PageGetSubComment:input_type -> comment.api.v1.PageGetSubCommentRequest
	24, // 45: comment.api.v1.CommentService.PageGetSubCommentV2:input_type -> comment.api.v1.PageGetSubCommentV2Request
	28, // 46: comment.api.v1.CommentService.PageGetDetailedComment:input_type -> comment.api.v1.PageGetDetailedCommentRequest
	30, // 47: comment.api.v1.CommentService.PageGetDetailedCommentV2:input_type -> comment.api.v1.PageGetDetailedCommentV2Request
	34, // 48: comment.api.v1.CommentService.GetPinnedComment:input_type -> comment.api.v1.GetPinnedCommentRequest
	36, // 49: comment.api.v1.CommentService.CountComment:input_type -> comment.api.v1.CountCommentRequest
	38, // 50: comment.api.v1.CommentService.BatchCountComment:input_type -> comment.api.v1.BatchCountCommentRequest
	40, // 51: comment.api.v1.CommentService.GetCommentLikeCount:input_type -> comment.api.v1.GetCommentLikeCountRequest
	42, // 52: comment.api.v1.CommentService.GetCommentDislikeCount:input_type -> comment.api.v1.GetCommentDislikeCountRequest
	44, // 53: comment.api.v1.CommentService.CheckUserOnObject:input_type -> comment.api.v1.CheckUserOnObjectRequest
	46, // 54: comment.api.v1.CommentService.BatchCheckUserOnObject:input_type -> comment.api.v1.BatchCheckUserOnObjectRequest
	50, // 55: comment.api.v1.CommentService.BatchCheckUserLikeComment:input_type -> comment.api.v1.BatchCheckUserLikeCommentRequest
	53, // 56: comment.api.v1.CommentService.UploadCommentImages:input_type -> comment.api.v1.UploadCommentImagesRequest
	6,  // 57: comment.api.v1.CommentService.AddComment:output_type -> comment.api.v1.AddCommentResponse
	8,  // 58: comment.api.v1.CommentService.DelComment:output_type -> comment.api.v1.DelCommentResponse
	10, // 59: comment.api.v1.CommentService.LikeAction:output_type -> comment.api.v1.LikeActionResponse
	12, // 60: comment.api.v1.CommentService.DislikeAction:output_type -> comment.api.v1.DislikeActionResponse
	14, // 61: comment.api.v1.CommentService.ReportComment:output_type -> comment.api.v1.ReportCommentResponse
	16, // 62: comment.api.v1.CommentService.PinComment:output_type -> comment.api.v1.PinCommentResponse
	21, // 63: comment.api.v1.CommentService.PageGetComment:output_type -> comment.api.v1.PageGetCommentResponse
	23, // 64: comment.api.v1.CommentService.PageGetSubComment:output_type -> comment.api.v1.PageGetSubCommentResponse
	25, // 65: comment.api.v1.CommentService.PageGetSubCommentV2:output_type -> comment.api.v1.PageGetSubCommentV2Response
	29, // 66: comment.api.v1.CommentService.PageGetDetailedComment:output_type -> comment.api.v1.PageGetDetailedCommentResponse
	33, // 67: comment.api.v1.CommentService.PageGetDetailedCommentV2:output_type -> comment.api.v1.PageGetDetailedCommentV2Response
	35, // 68: comment.api.v1.CommentService.GetPinnedComment:output_type -> comment.api.v1.GetPinnedCommentResponse
	37, // 69: comment.api.v1.CommentService.CountComment:output_type -> comment.api.v1.CountCommentResponse
	39, // 70: comment.api.v1.CommentService.BatchCountComment:output_type -> comment.api.v1.BatchCountCommentResponse
	41, // 71: comment.api.v1.CommentService.GetCommentLikeCount:output_type -> comment.api.v1.GetCommentLikeCountResponse
	43, // 72: comment.api.v1.CommentService.GetCommentDislikeCount:output_type -> comment.api.v1.GetCommentDislikeCountResponse
	45, // 73: comment.api.v1.CommentService.CheckUserOnObject:output_type -> comment.api.v1.CheckUserOnObjectResponse
	49, // 74: comment.api.v1.CommentService.BatchCheckUserOnObject:output_type -> comment.api.v1.BatchCheckUserOnObjectResponse
	52, // 75: comment.api.v1.CommentService.BatchCheckUserLikeComment:output_type -> comment.api.v1.BatchCheckUserLikeCommentResponse
	54, // 76: comment.api.v1.CommentService.UploadCommentImages:output_type -> comment.api.v1.UploadCommentImagesResponse
