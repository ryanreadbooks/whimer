...
func (x *ListFeedByUidRequest) GetCursor() uint64 {
	if x != nil {
		return x.Cursor
	}
	return 0
...
func (x *ListFeedByUidResponse) GetNextCursor() uint64 {
	if x != nil {
		return x.NextCursor
	}
	return 0
...
var file_v1_notefeed_proto_rawDesc = []byte{
	...
	0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x6e,
	0x6f, 0x74, 0x65, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x2e, 0x46, 0x65, 0x65, 0x64, 0x4e,
	0x6f, 0x74, 0x65, 0x49, 0x74, 0x65, 0x6d, 0x52, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x22, 0x56,
	0x0a, 0x14, 0x4c, 0x69, 0x73, 0x74, 0x46, 0x65, 0x65, 0x64, 0x42, 0x79, 0x55, 0x69, 0x64, 0x52,
	...
	0x05, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x84, 0x01, 0x0a, 0x15, 0x4c, 0x69, 0x73, 0x74, 0x46,
	...
	0x19, 0x2e, 0x6e, 0x6f, 0x74, 0x65, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x2e, 0x46, 0x65,
	0x65, 0x64, 0x4e, 0x6f, 0x74, 0x65, 0x49, 0x74, 0x65, 0x6d, 0x52, 0x05, 0x69, 0x74, 0x65, 0x6d,
	...
	0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x68, 0x61, 0x73, 0x4e, 0x65, 0x78, 0x74, 0x32, 0xc0, 0x03,
	...
	0x65, 0x65, 0x64, 0x42, 0x79, 0x55, 0x69, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x42, 0x9b, 0x01, 0x0a, 0x0f, 0x63, 0x6f, 0x6d, 0x2e, 0x6e, 0x6f, 0x74, 0x65, 0x2e, 0x61, 0x70,
	0x69, 0x2e, 0x76, 0x31, 0x42, 0x0d, 0x4e, 0x6f, 0x74, 0x65, 0x66, 0x65, 0x65, 0x64, 0x50, 0x72,
...
var file_v1_notefeed_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_v1_notefeed_proto_goTypes = []any{
	...
	(*ListFeedByUidRequest)(nil),      // 9: note.api.v1.ListFeedByUidRequest
	(*ListFeedByUidResponse)(nil),     // 10: note.api.v1.ListFeedByUidResponse
	(*NoteImage)(nil),                 // 11: note.api.v1.NoteImage
}
var file_v1_notefeed_proto_depIdxs = []int32{
	2,  // 0: note.api.v1.RandomGetResponse.items:type_name -> note.api.v1.FeedNoteItem
	11, // 1: note.api.v1.FeedNoteItem.images:type_name -> note.api.v1.NoteImage
	...
	2,  // 4: note.api.v1.ListFeedByUidResponse.items:type_name -> note.api.v1.FeedNoteItem
	0,  // 5: note.api.v1.NoteFeedService.RandomGet:input_type -> note.api.v1.RandomGetRequest
	3,  // 6: note.api.v1.NoteFeedService.GetFeedNote:input_type -> note.api.v1.GetFeedNoteRequest
	5,  // 7: note.api.v1.NoteFeedService.RecommendGet:input_type -> note.api.v1.RecommendGetRequest
	7,  // 8: note.api.v1.NoteFeedService.GetUserRecentPost:input_type -> note.api.v1.GetUserRecentPostRequest
	9,  // 9: note.api.v1.NoteFeedService.ListFeedByUid:input_type -> note.api.v1.ListFeedByUidRequest
	1,  // 10: note.api.v1.NoteFeedService.RandomGet:output_type -> note.api.v1.RandomGetResponse
	4,  // 11: note.api.v1.NoteFeedService.GetFeedNote:output_type -> note.api.v1.GetFeedNoteResponse
	6,  // 12: note.api.v1.NoteFeedService.RecommendGet:output_type -> note.api.v1.RecommendGetResponse
	8,  // 13: note.api.v1.NoteFeedService.GetUserRecentPost:output_type -> note.api.v1.GetUserRecentPostResponse
	10, // 14: note.api.v1.NoteFeedService.ListFeedByUid:output_type -> note.api.v1.ListFeedByUidResponse
