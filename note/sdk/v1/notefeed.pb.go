...
func (x *GetNoteDetailRequest) GetNoteId() uint64 {
	if x != nil {
		return x.NoteId
	}
	return 0
...
var file_v1_notefeed_proto_rawDesc = []byte{
	...
	0x28, 0x05, 0x52, 0x05, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x38, 0x0a, 0x14, 0x47, 0x65, 0x74,
	0x4e, 0x6f, 0x74, 0x65, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	...
	0x65, 0x49, 0x64, 0x22, 0x17, 0x0a, 0x15, 0x47, 0x65, 0x74, 0x4e, 0x6f, 0x74, 0x65, 0x44, 0x65,
	0x74, 0x61, 0x69, 0x6c, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xb5, 0x01, 0x0a,
	...
	,
...
var file_v1_notefeed_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_v1_notefeed_proto_goTypes = []any{
	...
	(*GetNoteDetailRequest)(nil),  // 2: note.sdk.v1.GetNoteDetailRequest
	(*GetNoteDetailResponse)(nil), // 3: note.sdk.v1.GetNoteDetailResponse
	(*NoteItem)(nil),              // 4: note.sdk.v1.NoteItem
}
var file_v1_notefeed_proto_depIdxs = []int32{
	4, // 0: note.sdk.v1.RandomGetResponse.items:type_name -> note.sdk.v1.NoteItem
	0, // 1: note.sdk.v1.NoteFeedService.RandomGet:input_type -> note.sdk.v1.RandomGetRequest
	2, // 2: note.sdk.v1.NoteFeedService.GetNoteDetail:input_type -> note.sdk.v1.GetNoteDetailRequest
	1, // 3: note.sdk.v1.NoteFeedService.RandomGet:output_type -> note.sdk.v1.RandomGetResponse
	3, // 4: note.sdk.v1.NoteFeedService.GetNoteDetail:output_type -> note.sdk.v1.GetNoteDetailResponse
...
func file_v1_notefeed_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_v1_notefeed_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*GetNoteDetailRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_v1_notefeed_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*GetNoteDetailResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
